...
class FourthPage extends StatefulWidget {
  const FourthPage({required this.fInputController,required this.inputcontroller,required this.formNtDate,required this.toNtDate,Key? key}) : super(key: key);
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    "어떤 여행을\n계획하고 계신가요?",
                    // '${widget.fInputController},${widget.inputcontroller},${widget.formNtDate},${widget.toNtDate}', // 데이터 테스트
                    style: TextStyle(
                      fontSize: 32,
                      fontFamily: "Mulish",
                ...
                Container(
                  ...
                  child:TextButton(
                    onPressed: (){
                      String prompt = "2023년 7월 12일부터 2023년 7월 14일까지 친구 한 명과 함께 가는 제주도 여행 일정 세워줘";
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => ResultPage(prompt)
                      ),
                      );
