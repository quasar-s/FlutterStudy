              ...
              children: [
                    ...
                    onPressed: () async{
                      ...
                      if (selectedDate != null) {
                        setState(() {
                          ...
                          formNtDate = formDate.year.toString()+'년'+formDate.month.toString().padLeft(2,'0')+'월'+formDate.day.toString().padLeft(2, '0')+'일';
                        });
                      }
                    },
                  ...
                  child: ElevatedButton(
                    onPressed: () async{
                      ...
                      if (selectedDate != null) {
                        setState(() {
                          toDate = selectedDate;
                          toNtDate = toDate.year.toString()+'년'+toDate.month.toString().padLeft(2,'0')+'월'+toDate.day.toString().padLeft(2, '0')+'일';
                        });
                      }
                    },
                    style: ElevatedButton.styleFrom(
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      if(formNtDate == '') {
                        formNtDate = DateTime.now().year.toString()+'년'+DateTime.now().month.toString().padLeft(2,'0')+'월'+DateTime.now().day.toString().padLeft(2, '0')+'일';
                      }
                      if(toNtDate == '') {
                        toNtDate = DateTime.now().year.toString()+'년'+DateTime.now().month.toString().padLeft(2,'0')+'월'+DateTime.now().day.toString().padLeft(2, '0')+'일';
                      }
                      Navigator.push(context,
                        MaterialPageRoute(
                            builder: (context) => FourthPage(fInputController: widget.fInputController,inputcontroller: widget.inputcontroller, formNtDate: formNtDate,toNtDate: toNtDate, selectedValue: _selectedValue,
                        ),
                      ),
                      );
                    },
